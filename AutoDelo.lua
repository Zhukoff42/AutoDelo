...
local UPDATE_JSON_URL = "https://fastly.jsdelivr.net/gh/Zhukoff42/AutoDelo@main/Update.json"
local SCRIPT_URL = "https://fastly.jsdelivr.net/gh/Zhukoff42/AutoDelo@main/AutoDelo.lua"
